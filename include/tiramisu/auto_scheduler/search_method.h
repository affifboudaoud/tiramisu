...
const std::vector<optimization_type> DEFAULT_OPTIMIZATIONS_ORDER = {UNFUSE, PARALLELIZE, TILING, UNROLLING};
const std::vector<optimization_type> DEFAULT_OPTIMIZATIONS_ORDER_MATRIX = {MATRIX};
