...
public:
     ...
     */
    void transform_ast();
    void transform_ast_matrix(std::vector< std::vector<int> > matrix);
    /**
     * Transform the AST by applying the given optimization.
     */
    void transform_ast(optimization_info const& opt);
    void transform_ast_matrix(optimization_info const& opt, std::vector < std::vector<int> > matrix);
    ...
    */
    bool program_is_legal(syntax_tree &ast_i) const;
