...
int main(int argc, char **argv)
{
    ...
    // Layer I
    // ------------------------------------------------------- 
    var y_in("y_in", 0, 1026), x_in("x_in", 0, 1538), x("x", 1, 1538 - 1), y("y", 1, 1026 - 1);
    ...
    buffer buff_input("buff_input", {1026, 1538}, p_float64, a_input);
    buffer buff_heat2d("buff_heat2d", {1026, 1538}, p_float64, a_output);
	...
	as.sample_search_space_random_matrix("./function_heat2d_LARGE_explored_schedules.json", true);
	delete scheds_gen;
	delete model_eval;
	delete bs;
	return 0;
