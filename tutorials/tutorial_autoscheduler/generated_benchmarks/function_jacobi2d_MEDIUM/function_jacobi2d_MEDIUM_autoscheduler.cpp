...
int main(int argc, char **argv)
{
    ...
    //Iteration variables    
    var i_f("i_f", 0, 386), j_f("j_f", 0, 386);
    var t("t", 0, 256), i("i", 1, 386-1), j("j", 1, 386-1);
    ...
    //Input Buffers
    buffer b_A("b_A", {386,386}, p_float64, a_output);    
	...
	as.sample_search_space_random_matrix("./function_jacobi2d_MEDIUM_explored_schedules.json", true);
	delete scheds_gen;
	delete model_eval;
	delete bs;
	return 0;
