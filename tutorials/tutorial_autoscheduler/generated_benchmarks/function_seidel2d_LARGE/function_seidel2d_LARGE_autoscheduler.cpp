...
int main(int argc, char **argv)
{
    ...
    var i_f("i_f", 0, 2050), j_f("j_f", 0, 2050);
    var t("t", 0, 512), i("i", 1, 2050-1), j("j", 1, 2050-1);
    ...
    buffer b_A("b_A", {2050,2050}, p_float64, a_output);    
	...
	as.sample_search_space_random_matrix("./function_seidel2d_LARGE_explored_schedules.json", true);
	delete scheds_gen;
	delete model_eval;
	delete bs;
	return 0;
