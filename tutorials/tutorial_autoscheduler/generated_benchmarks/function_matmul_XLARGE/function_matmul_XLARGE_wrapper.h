...
extern "C" {
#endif
int function_matmul_XLARGE(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", std::to_string((double)(2560*2048+3072*2560+3072*2048)*8/1024/1024).c_str(), true); // This value was set by the Code Generator
}
