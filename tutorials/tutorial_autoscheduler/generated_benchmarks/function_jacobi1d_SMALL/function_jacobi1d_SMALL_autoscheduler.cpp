...
int main(int argc, char **argv)
{
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer b_A("b_A", {130}, p_float64, a_output);    
	...
	as.sample_search_space_random_matrix("./function_jacobi1d_SMALL_explored_schedules.json", true);
	delete scheds_gen;
	delete model_eval;
	delete bs;
	return 0;
