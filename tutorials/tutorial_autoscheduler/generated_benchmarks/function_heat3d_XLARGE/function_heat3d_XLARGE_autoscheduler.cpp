...
int main(int argc, char **argv)
{
    ...
    // -------------------------------------------------------     
    //for heat3d_init
    var x_in("x_in", 0, 258), y_in("y_in", 0, 258), z_in("z_in", 0, 258), t_in("t_in", 0, 2048);
    //for heat3d_c
    var x("x",1,258-1), y("y",1,258-1), z("z",1,258-1), t("t",0,2048);
    ...
    // -------------------------------------------------------    
    //buffers
    buffer b_out("b_out",{258,258,258},p_float64,a_output);
	...
	as.sample_search_space_random_matrix("./function_heat3d_XLARGE_explored_schedules.json", true);
	delete scheds_gen;
	delete model_eval;
	delete bs;
	return 0;
