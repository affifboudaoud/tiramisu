...
{
	double *c_buf00 = (double*)malloc(194*66* sizeof(double));
	parallel_init_buffer(c_buf00, 194*66, (double)85);
	Halide::Buffer<double> buf00(c_buf00, 194,66);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000009(buf00.raw_buffer());
