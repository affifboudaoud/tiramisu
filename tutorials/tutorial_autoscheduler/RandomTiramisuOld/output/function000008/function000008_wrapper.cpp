...
{
	double *c_buf00 = (double*)malloc(64*34* sizeof(double));
	parallel_init_buffer(c_buf00, 64*34, (double)96);
	Halide::Buffer<double> buf00(c_buf00, 64,34);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000008(buf00.raw_buffer());
