...
{
	double *c_buf00 = (double*)malloc(1026*1282* sizeof(double));
	parallel_init_buffer(c_buf00, 1026*1282, (double)90);
	Halide::Buffer<double> buf00(c_buf00, 1026,1282);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000005(buf00.raw_buffer());
