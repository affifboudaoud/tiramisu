...
{
	double *c_buf00 = (double*)malloc(450*450*66* sizeof(double));
	parallel_init_buffer(c_buf00, 450*450*66, (double)14);
	Halide::Buffer<double> buf00(c_buf00, 450,450,66);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function7522636(buf00.raw_buffer());
