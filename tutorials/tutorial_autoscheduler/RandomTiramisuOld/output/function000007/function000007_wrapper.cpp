...
{
	double *c_buf00 = (double*)malloc(64*448*129* sizeof(double));
	parallel_init_buffer(c_buf00, 64*448*129, (double)72);
	Halide::Buffer<double> buf00(c_buf00, 64,448,129);

	double *c_buf01 = (double*)malloc(129* sizeof(double));
	parallel_init_buffer(c_buf01, 129, (double)17);
	Halide::Buffer<double> buf01(c_buf01, 129);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function000007(buf00.raw_buffer(),buf01.raw_buffer());
