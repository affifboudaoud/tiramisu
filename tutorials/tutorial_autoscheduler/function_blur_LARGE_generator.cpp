...
int main(int argc, char **argv)
{
    ...
    // Layer I
    // ------------------------------------------------------- 
    var xi("xi", 0, 1026), yi("yi", 0, 514), ci("ci", 0, 5);
    var x("x", 1, 1026-1), y("y", 1, 514-1), c("c", 1, 5-1);
    ...
    // -------------------------------------------------------
    //Buffers
    buffer input_buf("input_buf", {5, 514, 1026}, p_float64, a_input);
    buffer output_buf("output_buf", {5,514, 1026}, p_float64, a_output);
    ...
    // Code Generation
    // -------------------------------------------------------
    tiramisu::codegen({&input_buf, &output_buf}, "./function_blur_LARGE.o");
