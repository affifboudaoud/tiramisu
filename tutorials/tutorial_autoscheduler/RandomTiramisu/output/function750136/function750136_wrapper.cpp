...
{
	double *c_buf00 = (double*)malloc(65*64* sizeof(double));
	parallel_init_buffer(c_buf00, 65*64, (double)31);
	Halide::Buffer<double> buf00(c_buf00, 65,64);

	double *c_buf01 = (double*)malloc(64*65*128* sizeof(double));
	parallel_init_buffer(c_buf01, 64*65*128, (double)88);
	Halide::Buffer<double> buf01(c_buf01, 64,65,128);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function750136(buf00.raw_buffer(),buf01.raw_buffer());
